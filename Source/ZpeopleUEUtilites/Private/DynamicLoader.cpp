...
UTexture2D* UImageLoader::LoadImageFromDisk( const FString& ImagePath)
{
	...
	return UZpeopleLoadSource::LoadTexture2DFromFile(ImagePath,Succss, Weight,Highting);
	//return UZpeopleLoadSource::LoadAndSaveBinTexFromFile(ImagePath,true,Succss, Weight, Highting);
}
