...
/**
*/
void UZpeopleLogHelpers::PrintLogString(UObject* WorldContextObject, const FString& InString, const FString& CategoryName, EZpeopleLogVerbosity verbosity,
                                          bool PrintToScreen, bool PrintToLog, FLinearColor TextColor /*= FColor::Blue*/, const float Duration /*= 0.0f*/)
{
    ...
    if(PrintToLog)
    {
        ...
        FMsg::Logf_Internal(nullptr, 0, *CategoryName, internalVerbosity, TEXT("%s"), *FinalDisplayString);
